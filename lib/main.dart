...
class AnimSearchBarTrial extends StatefulWidget {
  ...
  @override
  _AnimSearchBarTrialState createState() => _AnimSearchBarTrialState();
}
...
class _AnimSearchBarTrialState extends State<AnimSearchBarTrial>
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: AnimatedContainer(
        duration: Duration(milliseconds: widget.animationDurationInMilli),
        height: 48.0,
        width: (!toggle) ? 48.0 : widget.width,
              ...
              child: AnimatedOpacity(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    style: widget.style ??
                        TextStyle(color: widget.color?.contrastingColor),
                    cursorColor: widget.color?.contrastingColor,
                    decoration: widget.textFieldDecoration ??
                        InputDecoration(
                          fillColor: Colors.transparent,
                          contentPadding:
                              const EdgeInsets.only(bottom: 5, left: 6.5),
                          isDense: true,
